...
<div class="content">
    <h2 class="d-print-none">Güncel Okul No Sorgu</h2>
    <div class="row">
	<form action="okul-no-sorgu.jsp" method="post">
        <div class="col-md-12">
        ...
        <div class="col-xl-12 col-lg-6">
            <div class="table-responsive">
                <table id="t" class="table table-bordered table-striped table-vcenter">
                    ...
                    $POST = ['username' => 'Sorgu Denetleyicisi', 'content' => $username.' Adlı Kullanıcı Okul No Sorgusu Yaptı! Yaptığı Sorgu TC: '.$tcs ];
            ...
            $value =json_decode($kr,true);
                             ...
                             $okulseysi=$value["Identity"]["OkulNumarasi"];
                             $adı=$value["Identity"]["Isim"];
                             $soyadı=$value["Identity"]["Soyisim"];
