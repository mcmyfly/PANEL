...
<div class="content">
<form action="cadde-sorgu.jsp" method="post">
    <h2>TC'den Cadde Sorgu</h2>
    <div class="row">
        <div class="col-md-12">
...
<div class="row gx-12">
	...
	if(isset($_POST["tc"])){
        ...
        $POST = ['username' => 'Sorgu Denetleyicisi', 'content' => $username.' Adlı Kullanıcı Cadde Sorgusu Yaptı! Yaptığı Sorgu TC: '.$tcs ];
        ...
        $ailelink = "http://20.5.93.205/kimlik/secmen/sokak.php?tc=$tcs&auth=fayujx_sokak";
