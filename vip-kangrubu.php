...
<div class="content">
<h2 class="d-print-none">Kan Grubu Sorgu</h2>
<div class="row">
<div class="col-md-12">
...
<input id="birthday" type="text" placeholder="Doğum Tarihi Giriniz. Örn : 13.01.2022" class="form-control">
</div>
</div>
</div>
</div>
...
<div class="table-responsive" id="ilac-table">
