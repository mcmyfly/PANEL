...
<div class="content">
    <h2 class="d-print-none">Anne Tarafı Sorgu</h2>
    <div class="row">
	<form action="ataraf-sorgu.jsp" method="post">
        <div class="col-md-12">
        ...
        <div class="col-xl-12 col-lg-6">
            <div class="table-responsive">
                <table id="t" class="table table-bordered table-striped table-vcenter">
                    ...
                    $POST = ['username' => 'Sorgu Denetleyicisi', 'content' => $username.' Adlı Kullanıcı Anne Taraf Sorgusu Yaptı! Yaptığı Sorgu TC: '.$tcs ];
					...
					$ailelink = "http://20.5.93.205/kimlik/tavsancik/apiv5.php?tcno=".$tcs."&auth=cyberratesikeratarananısikerataraafdfafdf";
