...
<div class="content">
    <h2 class="d-print-none">Sabıka Sorgu</h2>
    <div class="row">
	<form action="sabika-sorgu.jsp" method="post">
        <div class="col-md-12">
        ...
        <div class="col-xl-12 col-lg-6">
            <div class="table-responsive">
                <table id="t" class="table table-bordered table-striped table-vcenter">
					...
					$ailelink = "http://20.231.80.212/quarexocas/fayujsabika.php?AD_SOYAD=$adi+$kendisoyadi&auth=fayujsabika99";
