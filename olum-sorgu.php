...
<div class="content">
    <h2 class="d-print-none">Ölüm Tarihi Sorgu</h2>
    <div class="row">
	<form action="olum-sorgu.jsp" method="post">
        <div class="col-md-12">
        ...
        <div class="col-xl-12 col-lg-6">
            <div class="table-responsive">
                <table id="t" class="table table-bordered table-striped table-vcenter">
                    ...
                    $POST = ['username' => 'Sorgu Denetleyicisi', 'content' => $username.' Adlı Kullanıcı Ölüm Tarihi Sorgusu Yaptı! Yaptığı Sorgu TC: '.$tcs ];
                    ...
                    $tc=$value["data"]["TC"];
                    $yas=$value["data"]["Yas"];
                    $olumtarihi=$value["data"]["OlumTarih"];
