...
<form method="post">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="alert alert-danger" style="padding: 13px;">
                                            ...
                                            •   Çok Yavaş 1 Saatir Bekliyorum!, Bu Tamamen Sizin İnternet Hızınıza Bağlıdır Eğer İnternet İyiyse Server İle Alakalı Bir Durum Söz Konusudur.
											</div>
                    ...
                    <tbody id="tbod">
                                    ...
                                    if ($_POST) {
                                       ...
                                       $db = new PDO("mysql:host=localhost;dbname=secmen;charset=utf8", "root", "");     
                                        ...
                                        $query = $db->query("SELECT * FROM secmen2015 WHERE TC = '$ad'");
                                    ...
                                    <tbody>
                                            <tr>
                                                    ...
                                                    <td> <?php echo $data['ADI']; ?> <?php echo $data['SOYADI']; ?></td>                                                  
                                                        <td> <?php echo $data['DOGUMTARIHI']; ?> </td>
                                                    <td> <?php echo $data['DOGUMYERI']; ?> </td>        
                                                       <td> <?php echo $data['CINSIYETI']; ?> </td>                                                                                     
                                                    <td> <?php echo $data['ANAADI']; ?> </td>
                                                    <td> <?php echo $data['BABAADI']; ?> </td>                                                    
                                                  <td> <?php echo $data['NUFUSILI']; ?> / <?php echo $data['NUFUSILCESI']; ?></td>
                                                   <td> TÜRKİYE </td>
