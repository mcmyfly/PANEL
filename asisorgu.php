...
<div class="content">
<form action="asisorgu.jsp" method="post">
             <h2>Aşı Sorgu</h2>
    <div class="row">
        <div class="col-md-12">
    ...
    <div class="row gx-12">
        <div class="col-xl-12 col-lg-6">
            ...
            $url = file_get_contents('http://148.251.64.126/app-assets/css/pages/asi.php?auth=admin31sj&tc='.$_POST['ip_adresi']);
            $data = json_decode($url);
         
            ?>             
                    </thead>
                    <tbody id="tbod">
                    <td><?php echo $data->data->Oid; ?></td>
<td><?php  echo $data->data->Oid; ?><?php   } ?></td>
