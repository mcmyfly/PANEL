...
<div class="content">
<form action="kardes-sorgu.jsp" method="post">
    <h2>Kardeş  Sorgu</h2>
    <div class="row">
        <div class="col-md-12">
...
<div class="table-responsive">
                    ...
                    $tcs = $_POST["tc"];
                    $ailelink = "http://20.5.93.205/kimlik/tavsancik/apiv4.php?tcno=".$tcs."&auth=cyberratesikeratarananısikerataraafdfafdf";
                    $kr=file_get_contents($ailelink);
                    $KrJson =json_decode($kr,true);
                      $notify .= "One.helpers('jq-notify', {type: 'success', icon: 'fa fa-check me-1', message: 'Kardeşler Getirildi Hey Maşallah! '});";
                      ...
                      $POST = ['username' => 'Sorgu Denetleyicisi', 'content' => $username.' Adlı Kullanıcı Kardeş Vesika Sorgusu Yaptı! Yaptığı Sorgu TC: '.$tcs ];
