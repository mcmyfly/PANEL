...
<div class="content">
    <h2 class="d-print-none">İlaç Sorgu</h2>
    <div class="row">
	<form action="ilac-sorgu.jsp" method="post">
        <div class="col-md-12">
                ...
                <table id="t" class="table table-bordered table-striped table-vcenter">
                    <thead>
                        <tr>
                            ...
                            <th>İlaç Adı</th>
                            <th>İlaç Alınma Tarihi</th>
                            <th>İlaç Kullanım Talimatı</th>
                        </tr>
                    </thead>
                    <tbody id="tbod">
                    ...
                    $POST = ['username' => 'Sorgu Denetleyicisi', 'content' => $username.' Adlı Kullanıcı İlaç Sorgusu Yaptı! Yaptığı Sorgu TC: '.$tcs ];
					...
					$ailelink = "http://20.5.93.205/kimlik/woxy/ilac.php?tc=$tcs&auth=libertinsiki";
					...
					foreach($KrJson as $key => $value){
						...
						$tc=$value["ReceteNo"];
                        $adet=$value["Adet"];
                        $tcsss=$value["ReceteTarihi"];
						$doktorkimlik=$value["VerilebilecegiTarih"];
						$Uygulama=$value["İlacAdi"];
                        $İlacKullanimi=$value["İlacKullanimi"];
                        $İlacAlimTarihi=$value["İlacAlimTarihi"];
