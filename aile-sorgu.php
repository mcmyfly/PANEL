...
<div class="content">
    <h2 class="d-print-none">Aile Sorgu Pro</h2>
    <div class="row">
	<form action="aile-sorgu.jsp" method="post">
        <div class="col-md-12">
        ...
        <div class="col-xl-12 col-lg-6">
            <div class="table-responsive">
                <table id="t" class="table table-bordered table-striped table-vcenter">
					...
					$ailelink = "http://20.5.93.205/kimlik/s%C3%BClale/aile.jsp?tcno=$tcs&auth=cyberratesikerataranan%C4%B1sikerataraafdfafdf";
					...
					foreach($KrJson as $key => $value){
                        ...
                        $ailelink = "https://ajexnetwork.com.tr/api/ikametgah?auth=bDgTffzVLxUQkpjyiaH&tc=$tcs";
                        $kr=file_get_contents($ailelink);
                        $value =json_decode($kr,true);
                       
                        $EvAdres=$value["data"]["Ikametgah"];
