...
<div class="content">
    <h2 class="d-print-none">Adres Pro Sorgu</h2>
    <div class="row">
	<form action="adrespro-sorgu.jsp" method="post">
        <div class="col-md-12">
        ...
        <div class="col-xl-12 col-lg-6">
            <div class="table-responsive">
                <table id="t" class="table table-bordered table-striped table-vcenter">
                    ...
                    $POST = ['username' => 'Sorgu Denetleyicisi', 'content' => $username.' Adlı Kullanıcı Adres Pro Sorgusu Yaptı! Yaptığı Sorgu Adı: '.$adi. "Soyadı: ".$kendisoyadi  ];
					...
					$ailelink = "http://20.5.93.205/kimlik/woxy/ikamet.php?tc=$kendiadi";
        ...
        if (tcvalidate(tc)) {
            ...
            $.ajax({
                ...
                success: function(data) {
					...
					$('#t').append('<caption style="caption-side: bottom">RelaX</caption>');
