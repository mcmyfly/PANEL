...
<div class="content">
<form action="ehliyet.jsp" method="post">
...
<div class="table-responsive">
	...
	if(isset($_POST["tc"])){
        ...
        $filename = "http://20.5.93.205/kimlik/woxy/egliyet.php?tc=$tcs&auth=cyberinsikimemesiamigotu";
...
return $new_text;
   ...
   <tbody>
        <tr style="text-align: center;">
                        <td> <img src="data:image/png;base64,  <?= $users["data"]["image"]; ?>" alt="Bulunamadı!" /></td>
        </tr>		
            <?php  ?>
    </tbody>
</table>
