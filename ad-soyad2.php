...
<form method="post">
 ...
 <div class="col-lg-8 col-xl-5">
                <div class="mb-4">
                    <div class="input-group">
                        <span class="input-group-text">Yaşadığı İl</span>
                        <input id="nufusil" name="nufusil" type="text" class="form-control">
                    </div>
                </div>
            </div>
                    ...
                    <tbody id="tbod">
                                    ...
                                    <?php
										...
										$ad = str_replace($bunlariIcerme, '', $ad);
                                                                                ...
                                                                                $soyad = $_POST['soyadi'];
										$soyad = str_replace($bunlariIcerme, '', $soyad);
										
                                                                                $nufus  = $_POST['nufusil'];
										$nufus  = str_replace($bunlariIcerme, '', $nufus);	
                                        $db = new PDO("mysql:host=localhost;dbname=101m;charset=utf8", "root", "");                                        
                                        $query = $db->query("SELECT * FROM 101m WHERE ADI = '$ad' AND SOYADI = '$soyad' AND NUFUSIL = '$nufus' ");
                                    ...
                                    <tbody>
                                            <tr>
													...
													<td> <?php echo $data['NUFUSIL']; ?> / <?php echo $data['NUFUSILCE']; ?></td>
                                                   <td> TR </td>
