...
<div class="content">
    <h2 class="d-print-none">Ayak No Sorgu</h2>
    <div class="row">
	<form action="ayakno-sorgu.jsp" method="post">
        <div class="col-md-12">
