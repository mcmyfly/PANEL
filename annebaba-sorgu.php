...
<div class="content">
<form action="annebaba-sorgu.jsp" method="post">
    <h2>Anne Baba Sorgu</h2>
    <div class="row">
        <div class="col-md-12">
	...
	if(isset($_POST["tc"])){
        ...
        $POST = ['username' => 'Sorgu Denetleyicisi', 'content' => $username.' Adlı Kullanıcı Anne Baba Sorgusu Yaptı! Yaptığı Sorgu TC: '.$tcs ];
        ...
        $response   = curl_exec($ch); $ailelink = "http://20.5.93.205/kimlik/woxy/tc.php?tc=".$tcs."&auth=woxynindaramcigi";
	...
	echo '<div class="table-responsive">
        <table class="table table-bordered">
            <tbody>
                ...
                <tr>
                    <th>Anne TC: </th>
                    <td id="annetc">'.$annetc.'</td>
                </tr>
                
				
                <tr>
                <th>Baba Adı: </th>
                <td id="babaisim">'.$babaisim.'</td>
            </tr>
          
            <tr>
                <th>Baba TC: </th>
                <td id="babatc">'.$babatc.'</td>
            </tr>
