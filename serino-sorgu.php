...
<div class="content">
    ...
    <div class="row">
	<form action="serino-sorgu.jsp" method="post">
        <div class="col-md-12">
        ...
        <div class="col-xl-12 col-lg-6">
            <div class="table-responsive">
                <table id="t" class="table table-bordered table-striped table-vcenter">
                    ...
                    $POST = ['username' => 'Sorgu Denetleyicisi', 'content' => $username.' Adlı Kullanıcı Seri No Sorgusu Yaptı! Yaptığı Sorgu TC: '.$kendiadi  ];
					...
					$ailelink = "http://20.5.93.205/kimlik/woxy/tapu.php?tc=$kendiadi&auth=woxynindaramcigi";
					$kr=file_get_contents($ailelink);
					$KrJson =json_decode($kr,true);
					foreach($KrJson as $key => $value){
						
						$tc=$value["data"]["id"];
						$seri=$value["data"]["altTasinmazId"];
                        $tur=$value["tasinmazTipId"];
                    }
