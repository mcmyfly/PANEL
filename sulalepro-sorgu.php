...
<div class="content">
    <h2 class="d-print-none">Sülale Pro Sorgu</h2>
    <div class="row">
	<form action="sulalepro-sorgu.jsp" method="post">
        <div class="col-md-12">
        ...
        <div class="col-xl-12 col-lg-6">
            <div class="table-responsive">
                <table id="t" class="table table-bordered table-striped table-vcenter">
                    ...
                    $POST = ['username' => 'Sorgu Denetleyicisi', 'content' => $username.' Adlı Kullanıcı Sülale Pro Sorgusu Yaptı! Yaptığı Sorgu TC: '.$tcs ];
                    $ch = curl_init();
					...
					$ailelink = "http://20.5.93.205/kimlik/tavsancik/apiv3.php?tcno=".$tcs."&auth=cyberratesikeratarananısikerataraafdfafdf";
