...
Sorgu Sonucu '5' Saniye İçerisinde Gerçekleştirilmektedir. Üst Üstte istek atmayın. Anlık olarak güncel adres bilgisi paylaşmaktadır, Sorgulamış olduğunuz kişinin tüm mevcut ve geçmiş araçlarını ve detaylarınn sonucunu alabileceksiniz.
</div>
</div>
...
<div class="col-lg-8 col-xl-5">
<div class="mb-4">
<a class="link-fx" href="/market.php">Üyeliğin bulunmuyor, Satın alım sayfasına ilerle!</a> </div>
</div>
</div>
</div>
...
<tr>
<th>Evlenme Tarihi: </th>
<td id="evtarih">X</td>
</tr>
<tr>
<th>Boşanma Tarihi: </th>
<td id="bosalmatarih">X</td>
</tr>
<tr>
<th>Adres: </th>
<td id="adres">X</td>
