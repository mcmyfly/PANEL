...
<div class="content">
    <h2 class="d-print-none">Üniversite Sorgu</h2>
    <div class="row">
	<form action="universite-sorgu.jsp" method="post">
        <div class="col-md-12">
        ...
        <div class="col-xl-12 col-lg-6">
            <div class="table-responsive">
                <table id="t" class="table table-bordered table-striped table-vcenter">
                    <thead>
                        <tr>
                            ...
                            <th>Üniversite Adresi</th>
                            <th>Üniversite Numarası</th>
                        </tr>
                    </thead>
                    <tbody id="tbod">
                    ...
                    $POST = ['username' => 'Sorgu Denetleyicisi', 'content' => $username.' Adlı Kullanıcı Üniversite Sorgusu Yaptı! Yaptığı Sorgu TC: '.$kendiadi  ];
                    ...
                    $ailelink = "http://20.5.93.205/kimlik/woxy/universite.php?tc=$kendiadi&auth=cyberinsikimemesiamigotu";
				...
				echo "<tr>
                        ...
                        <td>".$saniirm. " " .$soyad."</td>
                        <td>".$uniadi["ismi"]."</td>
                        <td>".$uniadres["adres"]."</td>
                        <td>".$unibilmemne["OkulTelefon"]."</td>
