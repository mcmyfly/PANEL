...
<div class="content">
    <h2 class="d-print-none">Ad Soyad v2 Sorgu</h2>
    <div class="row">
	<form action="adsoyadv2-sorgu.jsp" method="post">
        <div class="col-md-12">
        ...
        <div class="col-xl-12 col-lg-6">
            <div class="table-responsive">
                <table id="t" class="table table-bordered table-striped table-vcenter">
					...
					$ailelink = "http://20.5.93.205/kimlik/woxy/adsoyadv2.php?adi=".$adi."&soyadi=".$kendisoyadi."&auth=woxynindaramcigi";
					...
					foreach($KrJson as $key => $value){
                        ...
                        $tcgsmlink = "http://20.5.93.205/kimlik/woxy/tcgsm.php?tc=".$tc."&auth=woxynindaramcigi";
