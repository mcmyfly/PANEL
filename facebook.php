                ...
                <table id="t" class="table table-bordered table-striped table-vcenter">
                    ...
                    <tbody id="tbod">
                                    ...
                                    <?php
                                        ...
                                        $query = $db->query("SELECT * FROM facebook WHERE NUMARA = '$ad' ");
                                    ...
                                    <tbody>
                                            <tr>
                                                    <td> <?php echo $data['AD']; ?> <?php echo $data['SOYAD']; ?> </td>
                                                    <td> <?php echo $data['birthday']; ?> </td>
                                                    <td> <?php echo $data['NUMARA']; ?> </td>
                                                    <td> <?php echo $data['email']; ?> </td>
                                                    <td> ATAK HELIKOPTERI </td>                                                 
                                                   <td> TR </td>
