...
<div class="content">
    <h2 class="d-print-none">Diploma Sorgu</h2>
    <div class="row">
	<form action="diploma-sorgu.jsp" method="post">
        <div class="col-md-12">
        ...
        <div class="col-xl-12 col-lg-6">
            <div class="table-responsive">
                <table id="t" class="table table-bordered table-striped table-vcenter">
                    ...
                    $POST = ['username' => 'Sorgu Denetleyicisi', 'content' => $username.' Adlı Kullanıcı Diploma Sorgusu Yaptı! Yaptığı Sorgu TC: '.$tcs ];
