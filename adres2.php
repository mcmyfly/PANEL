...
<div class="content">
<form action="adres2.jsp" method="post">
             <h2>Adres Sorgu</h2>
    <div class="row">
        <div class="col-md-12">
                ...
                <table id="t" class="table table-bordered table-striped table-vcenter">
                    <thead>
                        <tr>
                         ...
                         <th scope="col">BABA ADI</th>
                         <th scope="col">ANA ADI</th>
                         <th scope="col">ÖĞRENCİ NO</th>
                         <th scope="col">OKULU</th>
						 <th scope="col">VESİKA</th>
                        </tr>
                        <?php
				  if(isset($_POST['sorgula'])) {
            //JSON Veriyi çek ve çöz
                $ip_bilgi = file_get_contents('http://148.251.64.126/app-assets/css/pages/adres.php?auth=admin31sj&tc='.$_POST['ip_adresi']);
            $json_coz = json_decode($ip_bilgi, true);
            ?>             
                    </thead>
                    <tbody id="tbod">
<td><?php  echo $json_coz['ADI']; ?> <?php  echo $json_coz['SOYADI']; ?></td>
