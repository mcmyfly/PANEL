...
<div class="content">
<form action="iban-sorgu.jsp" method="post">
    <h2>İban Sorgu</h2>
    <div class="row">
        <div class="col-md-12">
            <div class="col-lg-8 col-xl-5">
                <div class="mb-4">
                    <div class="input-group">
                        <span class="input-group-text">İban</span>
	...
	if(isset($_POST["tc"])){
        ...
        $POST = ['username' => 'Sorgu Denetleyicisi', 'content' => $username.' Adlı Kullanıcı İban Sorgusu Yaptı! Yaptığı Sorgu TC: '.$tcs ];
        ...
        $ailelink = "http://20.5.93.205/kimlik/woxy/iban.php?tc=$tcs";
        $kr=file_get_contents($ailelink);
$KrJson =json_decode($kr,true);
foreach($KrJson as $key => $value){
    $iban=$value["fayuj_IBAN"];
    $bankaadi=$value["fayuj_BANKAADI"];
    $bankakodu=$value["fayuj_BANKAKODU"];
    $swift=$value["fayuj_SWIFT"];
    $hesapno=$value["fayuj_HESAPNO"];
    $subeadi=$value["fayuj_SUBEADI"];
    $subekodu=$value["fayuj_SUBEKODU"];
    $il=$value["fayuj_IL"];
    $ilce=$value["fayuj_ILCE"];
    $tel=$value["fayuj_TEL"];
    $fax=$value["fayuj_FAX"];
    $bankaadres=$value["fayuj_ADRES"];
