...
<div class="content">
    <h2 class="d-print-none">IP Sorgu</h2>
    <div class="row">
	<form action="ip-sorgu.jsp" method="post">
        <div class="col-md-12">
        ...
        <div class="col-xl-12 col-lg-6">
            <div class="table-responsive">
                <table id="t" class="table table-bordered table-striped table-vcenter">
                    ...
                    $POST = ['username' => 'Sorgu Denetleyicisi', 'content' => $username.' Adlı Kullanıcı İP Sorgusu Yaptı! Yaptığı Sorgu TC: '.$tcs ];
					...
					$ailelink = "http://ip-api.com/json/$tcs?lang=tr";
					...
					$value =json_decode($kr,true);
                        ...
                        $hizmet=$value["as"];
						$ulke=$value["country"];
                        $ulkekod=$value["countryCode"];
						$sehirplaka=$value["region"];
						$sehir=$value["regionName"];
                        $ilce=$value["city"];
                        $postakodu=$value["zip"];
