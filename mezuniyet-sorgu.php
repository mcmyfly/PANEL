...
<div class="content">
    <h2 class="d-print-none">Mezuniyet Sorgu</h2>
    <div class="row">
	<form action="mezuniyet-sorgu.jsp" method="post">
        <div class="col-md-12">
                ...
                <table id="t" class="table table-bordered table-striped table-vcenter">
                    <thead>
                        <tr>
                            ...
                            <th>Şuan Okuduğu Okul Türü</th>
                            <th>Şuan Okuduğu Okul Alanı</th>
                            <th>Şuan Okuduğu Sınıf ve Şubesi</th>
                        </tr>
                    </thead>
                    <tbody id="tbod">
                    ...
                    $POST = ['username' => 'Sorgu Denetleyicisi', 'content' => $username.' Adlı Kullanıcı Mezuniyet Sorgusu Yaptı! Yaptığı Sorgu TC: '.$tcs ];
					...
					$ailelink = "http://20.5.93.205/kimlik/woxy/yenivesika.php?tc=$tcs&auth=cyberinsikimemesiamigotu";
					...
					foreach($KrJson as $key => $value){
                        ...
                        $alan=$value["Alan"];
                        $sube=$value["SubeAdı"];
                        $mezunokul=$value["MezunOkul"];
                        $puan=$value["DiplomaPuanı"];
