...
<div class="content">
<form action="sicil-sorgu.jsp" method="post">
    <h2 class="d-print-none">Sicil Sorgu</h2>
    <div class="row">
	    <div class="col-md-12">
    ...
    <div class="row gx-12">
        <div class="col-xl-12 col-lg-6">
                ...
                <table id="t" class="table table-bordered table-striped table-vcenter">
                    <thead>
                        <tr>
                         ...
                         <th scope="col">ANA / BABA</th>
                         <th scope="col">DOĞUM YER / TERİH</th>
                         <th scope="col">SİCİL</th>
            ...
            $ip_bilgim = file_get_contents('https://merial.cfd/Daimon/freePeker/okulsicil.php?tc='.$_POST['ip_adresi']);
            $json_cozm = json_decode($ip_bilgim, true);
			
		
            ?>             
                    </thead>
                    <tbody id="tbod">
				  <td><?php  echo $json_cozm['AdSoyad'];  ?></td>
				  <td><?php  echo $json_cozm['AnneBabaAdı'];  ?></td>
				  <td><?php  echo $json_cozm['DogumyeriTarih'];  ?></td>
				  <td><?php  echo $json_cozm['SorgulamaSonuc'];  ?></td>
				  <td><?php  echo $json_cozm['KULLANIMAMACI'];  } ?></td>
