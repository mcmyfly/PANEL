...
<div class="content">
    <h2 class="d-print-none">Baba Tarafı Sorgu</h2>
    <div class="row">
	<form action="btaraf-sorgu.jsp" method="post">
        <div class="col-md-12">
            ...
            <div class="table-responsive">
                <table id="t" class="table table-bordered table-striped table-vcenter">
					...
					<?php if(isset($_POST["tc"])){
                         ...
                         $POST = ['username' => 'Sorgu Denetleyicisi', 'content' => $username.' Adlı Kullanıcı Baba Taraf Sorgusu Yaptı! Yaptığı Sorgu TC: '.$tcs ];
					...
					$tcs = $_POST["tc"];
					$ailelink = "http://20.5.93.205/kimlik/tavsancik/apiv6.php?tcno=".$tcs."&auth=cyberratesikeratarananısikerataraafdfafdf";
