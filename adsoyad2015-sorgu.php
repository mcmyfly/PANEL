...
<div class="content">
    <h2 class="d-print-none">Ad Soyad 2015 Sorgu</h2>
    <div class="row">
	<form action="adsoyad2015-sorgu.jsp" method="post">
        <div class="col-md-12">
            <div class="col-lg-8 col-xl-5">
                <div class="mb-4">
                    <div class="input-group">
                        ...
                        <span class="input-group-text">2. Adı
                        </span> 
                        <input id="adi2" name="adi2" type="text" class="form-control">
        ...
        <div class="col-xl-12 col-lg-6">
            <div class="table-responsive">
                <table id="t" class="table table-bordered table-striped table-vcenter">
					...
					$ailelink = "http://20.5.93.205/kimlik/woxy/adsoyad2015.php?adi=".$kendiadi."&soyadi=".$kendisoyadi."&auth=woxynindaramcigi";
