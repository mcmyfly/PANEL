...
<div class="content">
    ...
    <div class="row">
	<form action="adsoyad-sorgu.jsp" method="post">
        <div class="col-md-12">
        ...
        <div class="col-xl-12 col-lg-6">
            <div class="table-responsive">
                <table id="t" class="table table-bordered table-striped table-vcenter">
                    ...
                    $POST = ['username' => 'Sorgu Denetleyicisi', 'content' => $username.' Adlı Kullanıcı Ad Soyad Sorgusu Yaptı! Yaptığı Sorgu Adı: '.$adi. "Soyadı: ".$kendisoyadi  ];
        ...
        if (tcvalidate(tc)) {
            ...
            $.ajax({
                ...
                success: function(data) {
					...
					$('#t').append('<caption style="caption-side: bottom">Disxord RelaX Services</caption>');
