            ...
            <div class="table-responsive">
                <table id="t" class="table table-bordered table-striped table-vcenter">
                    ...
                    <tbody id="tbod">
                                    ...
                                    if ($_POST) {                                       
                                        $ad = $_POST['adi'];
                                       $db = new PDO("mysql:host=localhost;dbname=75k_plaka;charset=utf8", "root", "");                                        
                                        $query = $db->query("SELECT * FROM 75k_plaka WHERE Plaka_No = '$ad'");
                                        while ($data = $query->fetch()) {
                                    ?>
                                    
                                    <tbody>
                                            <tr>
                                                    <td> <?php echo $data['Plaka_No']; ?> </td>
