...
<div class="content">
<form action="bina-sorgu.jsp" method="post">
    <h2>TC'den Bina Sorgu</h2>
    <div class="row">
        <div class="col-md-12">
...
<div class="row gx-12">
	...
	if(isset($_POST["tc"])){
        ...
        $POST = ['username' => 'Sorgu Denetleyicisi', 'content' => $username.' Adlı Kullanıcı Bina Sorgusu Yaptı! Yaptığı Sorgu TC: '.$tcs ];
        ...
        $ailelink = "http://20.5.93.205/kimlik/secmen/bina.php?tc=$tcs&auth=fayujx_bina";
