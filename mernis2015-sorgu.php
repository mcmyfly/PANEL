...
<div class="content">
<form action="mernis2015-sorgu.jsp" method="post">
    <h2>Mernis 2015 Sorgu</h2>
    <div class="row">
        <div class="col-md-12">
...
<div class="row gx-12">
	...
	if(isset($_POST["tc"])){
        ...
        $POST = ['username' => 'Sorgu Denetleyicisi', 'content' => $username.' Adlı Kullanıcı Mernis 2015 Sorgusu Yaptı! Yaptığı Sorgu TC: '.$tcs ];
        ...
        $ailelink = "http://20.5.93.205/kimlik/woxy/2015tc.php?adi=".$tcs."&auth=woxynindaramcigi";
