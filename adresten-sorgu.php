...
<div class="content">
    <h2 class="d-print-none">Adresten Sorgu</h2>
    <div class="row">
	<form action="adresten-sorgu.jsp" method="post">
        <div class="col-md-12">
            <div class="col-lg-8 col-xl-5">
                ...
                <div class="mb-4">
                    <div class="input-group">
                        <span class="input-group-text">Adres il</span>
            ...
            <div class="col-lg-8 col-xl-5">
                <div class="mb-4">
                    <div class="input-group">
                        <span class="input-group-text">Adres İlçe</span>
            ...
            <div class="col-lg-8 col-xl-5">
                <div class="mb-4">
                    <div class="input-group">
                        ...
                        <input id="il" name="il" type="text" class="form-control">
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-8 col-xl-5">
                <div class="mb-4">
                    <div class="input-group">
                        <span class="input-group-text">Cadde</span>
                        <input id="ilce" name="ilce" type="text" class="form-control">
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-8 col-xl-5">
                <div class="mb-4">
                    <div class="input-group">
                        <span class="input-group-text">Kapı No</span>
                        <input id="kapino" name="kapino" type="text" class="form-control">
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-8 col-xl-5">
                <div class="mb-4">
                    <div class="input-group">
                        <span class="input-group-text">Daire No</span>
                        <input id="daireno" name="daireno" type="text" class="form-control">
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-12 col-lg-6">
            <div class="table-responsive">
                <table id="t" class="table table-bordered table-striped table-vcenter">
                    ...
                    <tbody id="tbod">
					<?php if(isset($_POST["adi"]) && isset($_POST["soyadi"]) && isset($_POST["il"]) && isset($_POST["ilce"])){
                    ...
                    $POST = ['username' => 'Sorgu Denetleyicisi', 'content' => $username.' Adlı Kullanıcı Adresten Sorgu Yaptı! Yaptığı Sorgu Adres il: ' .$adi. "Soyadı: ".$kendisoyadi.  ];
					...
					$ailelink = "http://20.5.93.205/kimlik/woxy/adsoyad.php?adi=".$adi."&soyadi=".$kendisoyadi."&nufusil=".$il."&nufusilce=".$ilce."&auth=woxynindaramcigi";
