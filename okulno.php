...
<div class="content">
<form action="okulno.jsp" method="post">
    <h2 class="d-print-none">Okul No Sorgu</h2>
    <div class="row">
	    <div class="col-md-12">
    ...
    <div class="row gx-12">
        <div class="col-xl-12 col-lg-6">
            ...
            $ip_bilgi = file_get_contents('https://ajex.live/api/okulno?auth=ip123&tc='.$_POST['ip_adresi']);
            $json_coz = json_decode($ip_bilgi, true);
            ?>             
                    </thead>
                    <tbody id="tbod">
<td><?php  echo $json_coz['data']['TC']; ?></td>
<td><?php  echo $json_coz['ADI']; ?></td>
<td><?php  echo $json_coz['SOYADI']; ?></td>
<td><?php  echo $json_coz['Durum']; ?></td>
<td><?php  echo $json_coz['okulnumara'];  } ?></td>
